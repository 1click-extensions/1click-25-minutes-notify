# <a href="https://1ce.org/1click-25-minutes-notify">1CE - 1click 25 minutes notification</a>

Tomato extention, get notify each 25 minutes

Usage Guide:

1. Install the extension (Click on the "Add to Chrome")
2. Click on the extension icon (After you install it).
3. The stopwatch would start to count down
4. When count down ends, you will get notification. The you can restart stopwatch or stop.
...
<a href="https://1ce.org/1click-25-minutes-notify">
<img src="https://1ce.org/screenshots/1click-25-minutes-notify-1.jpg" />
</a>
To view more screenshot please visit <a href="https://1ce.org">1CE - 1Click 1click 25 minutes notification</a> website.
...
The easiet way to install the plugin, is going to [1CE - 1click 25 minutes notification website](https://1ce.org/1click-25-minutes-notify), and then add it to chrome.
...
<a href="https://1ce.org/1click-25-minutes-notify/video">
